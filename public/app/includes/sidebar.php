...
<div class="sidebar">
    ...
    <div class="sidebar-header">
        <img src="/vilcon-system-github-main/public/assets/img/logo-vilcon.png" alt="Vilcon Logo" style="width:200px;">
    ...
    <div class="nav-menu">
        ...
        <div class="menu-section">
            <?php if (in_array('transporte', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/transporte/index.php?tab=hse&view=checklist&mode=list"
            ...
            <?php if (in_array('dashboard', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/dashboard/index.php"
            ...
            <?php if (in_array('documental', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/documental/index.php"
            ...
            <?php if (in_array('oficina', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/oficina/index.php"
            ...
            <?php if (in_array('transporte', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/transporte/index.php"
                   class="nav-link sub <?= (strpos($pagina_atual, '/transporte/') !== false && $tabAtual === '') ? 'active' : '' ?>">
                    <i class="fa-solid fa-truck-ramp-box"></i> Transporte
                </a>
                <a href="/vilcon-system-github-main/public/app/modules/transporte/index.php?tab=gestao_frota"
                ...
                <a href="/vilcon-system-github-main/public/app/modules/transporte/index.php?tab=aluguer&view=modulo&mode=list"
                ...
                <a href="/vilcon-system-github-main/public/app/modules/transporte/index.php?tab=frentista"
            ...
            <?php if (in_array('rh', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/rh/index.php"
            ...
            <?php if (in_array('seguranca', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/seguranca/index.php"
            ...
            <?php if (in_array('logistica', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/logistica/index.php"
            ...
            <?php if (in_array('aprovacoes', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/aprovacoes/index.php"
            ...
            <?php if (in_array('relatorios', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/relatorios/index.php"
            ...
            <?php if (in_array('utilizadores', $acessos, true)): ?>
                <a href="/vilcon-system-github-main/public/app/modules/utilizadores/index.php"
   ...
   <a href="/vilcon-system-github-main/public/logout.php" class="btn-sair">
