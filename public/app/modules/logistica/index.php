...
function configModoSecaoLogistica(string $secao): array {
  $map = [
    'requisicoes' => [
      'list' => ['view' => 'pedidos_oficina', 'mode' => 'list'],
      'form' => ['view' => 'requisicoes', 'mode' => 'form'],
    ],
    'financas' => [
      'list' => ['view' => 'extratos', 'mode' => 'list'],
      'form' => ['view' => 'fornecedores', 'mode' => 'form'],
    ],
    'stock' => [
      'list' => ['view' => 'pecas', 'mode' => 'list'],
      'form' => ['view' => 'pecas', 'mode' => 'form'],
    ],
    'operacional' => [
      'list' => ['view' => 'oper_uniforme', 'mode' => 'list'],
      'form' => ['view' => 'oper_uniforme', 'mode' => 'form'],
    ],
    'budjet' => [
      'list' => ['view' => 'budjet', 'mode' => 'list'],
      'form' => ['view' => 'budjet', 'mode' => 'list', 'departamento' => 'oficina'],
    ],
    'alertas' => [
      'list' => ['view' => 'alertas', 'mode' => 'list'],
      'form' => ['view' => 'requisicoes', 'mode' => 'form'],
    ],
    'relatorios' => [
      'list' => ['view' => 'relatorios', 'mode' => 'list'],
      'form' => ['view' => 'requisicoes', 'mode' => 'form'],
    ],
  ];
  return $map[$secao] ?? $map['requisicoes'];
}
...
<div class="main-content">
    ...
    <div class="dashboard-container logi-page">
        ...
        <?php
            $secaoToggle = ($view === 'relatorios') ? 'relatorios' : $secao;
            $modoSecao = configModoSecaoLogistica($secaoToggle);
            $urlList = '?'.http_build_query($modoSecao['list']);
            $urlForm = '?'.http_build_query($modoSecao['form']);
            $isListActive = ($view === (string)$modoSecao['list']['view']) && (($mode ?? 'list') === (string)$modoSecao['list']['mode']);
            $isFormActive = ($view === (string)$modoSecao['form']['view']) && (($mode ?? 'list') === (string)$modoSecao['form']['mode']);
            $opcoesSecao = opcoesSecaoLogistica($secao);
        ?>
        ...
        <div class="logi-toggle">
            <a class="<?= $isListActive ? 'active' : '' ?>" href="<?= htmlspecialchars($urlList) ?>">Ver Lista</a>
            <a class="<?= $isFormActive ? 'active' : '' ?>" href="<?= htmlspecialchars($urlForm) ?>">Adicionar Novo</a>
        </div>
